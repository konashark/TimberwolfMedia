...
(function() {
    ...
    this.getPortfolioData = function () {
        var portfolio = [];
        portfolio[0] = {};
        portfolio[0].label = 'Art by Wendy';
        portfolio[0].images = [
            ...
            { url: 'images/artwork-web/13.jpg' },
            { url: 'images/artwork-web/14.jpg' },
            { url: 'images/artwork-web/15.jpg' },
            { url: 'images/artwork-web/16.jpg' },
            { url: 'images/artwork-web/18.jpg' },
        ...
        portfolio[1] = {};
        portfolio[1].label = 'Pet Portraits';
        portfolio[1].images = [
            ...
            { url: 'images/pets-web/9.jpg' },
            { url: 'images/pets-web/10.jpg' },
